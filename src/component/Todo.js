            ...
            <div className="main-div">
                <div className="todo-div">
                    ...
                    <div className="add-items">
                        <input type="text" name="" value={addItem} onChange={(e) => setaddItem(e.target.value)} placeholder="Add Item..." id="" />

                        {
                            toggleaUpdate ? <AddIcon titleAccess="add items" className="add-btn" onClick={addData} /> :
                            <DoneIcon titleAccess='Update' className="update-item" onClick={addData}/>
                        }
...

                        {
                            items.map((elem) =>{
                                return(
                                    ...
                                    <h5>{elem.name}</h5>
                                    <EditIcon titleAccess='Edit' className="edit-item" onClick={() => editItem(elem.id)}/>
                                    </div>
                                    <DeleteIcon titleAccess="remove item" className="remove-btn" onClick={() => removeItem(elem.id)} />
                                    </div>
                                )
                            })
                        }
